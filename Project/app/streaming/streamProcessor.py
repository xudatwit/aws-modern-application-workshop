...
def retrieveMysfit(mysfitId):
    apiEndpoint = 'https://wdsdg8cn6g.execute-api.us-east-1.amazonaws.com/prod' + '/mysfits/' + str(mysfitId) # eg: 'https://ljqomqjzbf.execute-api.us-east-1.amazonaws.com/prod/'
